...
// idol3.toUpperCase(); // 'string | number' 형식에 'toUpperCase' 속성이 없습니다. 'number' 형식에 'toUpperCase' 속성이 없습니다.

// idol3.toFixed(); // 'string | number' 형식에 'toFixed' 속성이 없습니다. 'string' 형식에 'toFixed' 속성이 없습니다.

idol3.toString(); // toString() : string과 number 타입 모두에서 사용할 수 있는 속성
...
// actor2.toUpperCase(); // 'string | number' 형식에 'toUpperCase' 속성이 없습니다. 'number' 형식에 'toUpperCase' 속성이 없습니다.
