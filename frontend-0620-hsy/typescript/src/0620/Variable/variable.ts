...
/*
    ...
    식별자 규칙
    알파벳 문자, 달러($)기호, 밑줄(_)로 시작 / 이후에 숫자도 포함가능
    공백을 포함할 수 X
    특수문자를 포함할 수 X(달러, 밑줄 예외)
    예약어를 사용할 수 X(let, const, var, function, class등)
*/

let computer: string = "samsung book3";
let $name: string = "SeongYoung";
let _color: string = "blue";
// let let: string = "hello const"; // 예약어